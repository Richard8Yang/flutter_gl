...
internal class VideoPlayer {
    ...
    constructor(
        ...
        setUpVideoPlayer(exoPlayer, QueuingEventSink(), eglContext)
    }
    ...
    private fun setUpVideoPlayer(exoPlayer: ExoPlayer, eventSink: QueuingEventSink?, eglContext: EGLContext) {
        ...
        renderer = VideoRender(this.textureEntry, eglContext)
