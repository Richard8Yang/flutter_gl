...
import 'dart:async';
import 'dart:io';
import 'package:flutter_gl/video_player/video_player_platform_interface.dart';
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  Future<void> setNetworkDataSource(
    ...
    return _setDataSource(
      DataSource(
        ...
        //httpHeaders: headers if headers != null else null
      ),
    );
  }
  ...
  Future<void> _applySpeed() async {
    ...
    await _videoPlayerPlatform.setPlaybackSpeed(_textureId!, value.speed);
  }
